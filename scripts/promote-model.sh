...
#       --model-name audiomind-vllm \
#       --model-version 3 \
#       --image ghcr.io/jgallego9/audiomind-mlops/vllm:sha-abc1234
#
# Required tools:
...
ROLLOUT_NAMESPACE="${ROLLOUT_NAMESPACE:-audiomind}"
ROLLOUT_NAME="${ROLLOUT_NAME:-audiomind-vllm}"
